...
function hamilton_setup() {
	...
	add_image_size( 'hamilton-featured-image', 640, 9999 );

	// This theme uses wp_nav_menu() in one location.
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Top', 'hamilton' ),
		) );
 ...
 */
function hamilton_the_custom_logo() {
...
function hamilton_scripts() {
	...
	wp_enqueue_script( 'hamilton-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'hamilton-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), '20151215', true );
